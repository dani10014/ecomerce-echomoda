function sanitizarHTML(a){var s=document.createElement("div");return s.textContent=a,s.innerHTML}class CriarProduto{constructor(a,s,r,e,i,t,o){this.id=a,this.nome=s,this.imagem=r,this.imagem2=e,this.imagem3=i,this.preco=t,this.categoria=o}devolverCard(){var a=document.createElement("div"),s=(a.classList.add("base-card"),""+this.id);a.innerHTML=`<div class='card' data-id="${s}">
                                ...
                                </div>`,"blusa"===this.categoria&&document.querySelector(".produtos-camisas .container-base-card").appendChild(a),"tenis"===this.categoria&&document.querySelector(".produtos-tenis .container-base-card").appendChild(a)}}async function buscarProdutos(){try{var a=await fetch("https://ecomerce-echomoda.onrender.com/api/buscar-produtos");if(!a.ok)throw new Error("Erro ao carregar JSON");var s=await a.json();if(!a.ok||!Array.isArray(s))throw new Error("Resposta inválida do servidor");s.forEach(a=>{new CriarProduto(a.id,a.nome,a.imagem,a.imagem2,a.imagem3,a.preco,a.categoria).devolverCard()})}catch(a){console.error("Falha no fetch:",a)}}export{buscarProdutos};