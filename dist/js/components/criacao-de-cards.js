function sanitizarHTML(a){var s=document.createElement("div");return s.textContent=a,s.innerHTML}class CriarProduto{constructor(a,s,e,r,o,i,t){this.id=a,this.nome=s,this.imagem=e,this.imagem2=r,this.imagem3=o,this.preco=i,this.categoria=t}devolverCard(){var a=document.createElement("div"),s=(a.classList.add("base-card"),""+this.id);a.innerHTML=`<div class='card' data-id="${s}">
