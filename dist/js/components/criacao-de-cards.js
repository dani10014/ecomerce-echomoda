function sanitizarHTML(a){var s=document.createElement("div");return s.textContent=a,s.innerHTML}class CriarProduto{constructor(a,s,e,i,r,t,o){this.id=a,this.nome=s,this.imagem=e,this.imagem2=i,this.imagem3=r,this.preco=t,this.categoria=o}devolverCard(){var a=document.createElement("div"),s=(a.classList.add("base-card"),""+this.id);a.innerHTML=`<div class='card' data-id="${s}">
