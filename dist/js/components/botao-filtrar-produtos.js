import{iniciarCarroselSlick}from"./carrosel-slick.js";function sanitizarHTML(a){var r=document.createElement("div");return r.textContent=String(a),r.innerHTML}function filtrarProdutos(){new produtosFiltrar}class criarCardFiltrado{constructor(a,r,t,e,i,o){this.nome=r,this.id=a,this.preco=t,this.imagem=e,this.imagem2=i,this.imagem3=o}devolverCard(){var a=document.createElement("div"),r=(a.classList.add("base-card"),""+this.id);return a.innerHTML=`
